...
public class MainActivity extends AppCompatActivity implements Runnable {
    ...
    private String[] mTestImages = {"test4.png","test5.jpg","test7.jpg"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            mModule = LiteModuleLoader.load(MainActivity.assetFilePath(getApplicationContext(), "plant_256_v2.ptl"));
            BufferedReader br = new BufferedReader(new InputStreamReader(getAssets().open("plant.txt")));
            String line;
